				...
				<ul style="padding-left:0px;" class="list-group">
					...
					<li class="list-group-item">
						...
						<ul style="margin-top:10px;">
							...
							<li style="height:30px;">
								<a href="${APPPATH }/role/show" style="color:red;"><i class="glyphicon glyphicon-certificate"></i> 角色维护</a> 
							</li>
							<li style="height:30px;">
			  ...
			  <div class="panel-body">
				<form role="form">
				  <div class="form-group">
					...
					<input type="text" class="form-control" id="rname" name="name" placeholder="请输入角色名称" value="${role.rname }">
				  </div>
        ...
        <script type="text/javascript">
            ...
            $("#updateBtn").click(function(){
            	$.ajax({
            		...
            		url:"roleUpdate",
            		type:"post",
            		data:{"rname":$("#rname").val(),"rid":$("#rid").val()},
            		async:true,
            		error:function(){
            			alert("error");
            		},
